...
const SCHRITTE = [
  {
    title: "Anfrage",
    text: "Sie schildern kurz, worum es geht: Dach, Rinne, Terrasse, Pflaster oder Garten. Fotos vom Ist-Zustand sparen die erste Runde Rückfragen."
  },
  {
    title: "Ortstermin",
    text: "Wir sehen uns das Dach oder die Fläche an, klären Zugang, Bestand und Anschlüsse. Erst danach reden wir über Preise."
  },
  {
    title: "Angebot",
  ...
  {
    title: "Übergabe",
    text: "Gemeinsame Abnahme mit Fotodokumentation. Bei Pflegeverträgen übernehmen wir die Anlage auf Wunsch dauerhaft."
  }
];
        ...
        <div className="grid grid-cols-12 gap-x-10 gap-y-14">
          <div className="col-span-12 lg:col-span-5">
            ...
            <p className="mt-6 max-w-[50ch] text-[15px] leading-relaxed text-bone/75">
              Ob Dachsanierung, Pflasterhof oder Gartenpflege: bei uns läuft jedes Projekt nach demselben Ablauf. Sie wissen an jedem Punkt, was als Nächstes passiert und woran Sie sind. Keine Überraschungen auf der Rechnung.
            </p>
