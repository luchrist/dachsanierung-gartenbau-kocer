...
const fallbackImages = [
  { src: "/assets/leistungen/gewerbliche-aussenanlagen.webp", alt: "Wohngebäude mit saniertem Dach und neuer Außenanlage" },
  { src: "/assets/leistungen/pflasterarbeiten-terrasse.webp", alt: "Team bei Pflasterarbeiten auf der Baustelle" },
  { src: "/assets/leistungen/terrassenbau-grossformatplatten-01.webp", alt: "Terrasse mit großformatigen Platten" },
  { src: "/assets/leistungen/gartenpflege-heckenschnitt.webp", alt: "Gartenpflege mit fachgerechtem Heckenschnitt" },
  { src: "/assets/leistungen/terrassenbau-grossformatplatten-02.webp", alt: "Detail einer neu verlegten Fläche" }
];
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 md:col-span-9">
            <h2 className="break-words font-display text-[32px] leading-[1.05] tracking-tight text-ink sm:text-[40px] md:text-[64px] lg:text-[78px]">
              Vom Dach bis zum Vorgarten,
              <br />
              <span className="italic text-laub-500">alles aus einer Hand.</span>
            </h2>
          </div>
        </div>
