      ...
      <div className="mx-auto max-w-[1400px] px-6 md:px-10">
        <div className="border-b border-ink/15 pb-12">
          ...
          <h2 className="mt-6 font-display text-[32px] leading-[1.05] tracking-tight text-ink sm:text-[40px] md:text-[58px]">
            Was wir <span className="italic text-laub-500">für Sie machen.</span>
          </h2>
          <p className="mt-6 max-w-[60ch] text-[15px] leading-relaxed text-ink/70">
            Vom Dach bis zum Vorgarten. Wir haben zwei Gewerke unter einem Dach, weil sie an vielen Stellen zusammenspielen. Kein Schnittstellenärger zwischen Firmen, ein Ansprechpartner.
          </p>
        </div>
