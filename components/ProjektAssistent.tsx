...
const RECURRING_SERVICE_KEYS = ["gartenpflege"];
  ...
  return (
    <div className="rounded-4xl border border-ink/10 bg-white p-6 shadow-[0_20px_60px_rgba(20,24,26,0.06)] md:p-10">
        ...
        <div>
          ...
          <div className="mt-4">
            ...
            <input
              ...
              placeholder="z.B. Dachfenster, Kaminverkleidung, Baumfällung"
            ...
            {needsLfm ? (
              <div>
                <label htmlFor="assistent-lfm" className="field-label">
                  Laufende Meter (Dachrinne / Anschluss)
                </label>
                <input
                  id="assistent-lfm"
                  inputMode="numeric"
      ...
      {step === 5 ? (
        <div>
          <p className="text-[15px] leading-relaxed text-ink/70">
            Fotos vom Dach, der Rinne, dem Vorgarten oder dem aktuellen Zustand. Auch Skizzen und Inspirationsbilder helfen. Optional, aber es spart meist eine ganze Runde Rückfragen.
          </p>
          <input
            ref={fileInputRef}
            type="file"
