...
export const metadata: Metadata = {
  title: `Angebot anfragen | ${company.name}`,
  description: `Dach-, Klempner- oder Gartenvorhaben strukturiert anfragen bei ${company.name} in ${company.address.city}: Projektart, Fotos, Budgetrahmen. Antwort innerhalb von 24 Stunden an Werktagen.`
};
      ...
      <section className="bg-ink pt-40 pb-16 md:pt-52 md:pb-24">
        <div className="mx-auto max-w-[1400px] px-6 md:px-10">
          <div className="flex items-center gap-3 font-mono text-[11px] uppercase tracking-[0.22em] text-bone/60">
            ...
            <span>Anfrage-Assistent</span>
          </div>
          <h1 className="mt-6 max-w-3xl font-display text-[36px] leading-[1.0] tracking-tight text-bone sm:text-[46px] md:text-[60px]">
            Angebot anfragen<span className="text-laub-300">.</span>
          </h1>
          <p className="mt-5 max-w-[54ch] text-[15px] leading-relaxed text-bone/80 md:text-[16px]">
            Acht kurze Schritte statt Telefon-Pingpong. Am Ende wissen Sie, ob Ihr Vorhaben in unser Einsatzgebiet passt und in welchem Rahmen es sich grob bewegt, und wir haben alles für eine belastbare Antwort.
          </p>
        </div>
      </section>
