...
/**
 * Eine Route für alle Leistungsseiten (Dachsanierung, Dachreparaturen,
 * Dachdämmung, Klempnerarbeiten, Pflaster, Terrassen, Gartenpflege, ...).
 * Inhalt kommt vollständig aus lib/galabau.ts, damit die Factory pro Betrieb
 * nur die Config seeden muss.
 */
          ...
          <div className="flex flex-col items-start justify-between gap-8 md:flex-row md:items-center">
            <div>
              <h2 className="font-display text-[26px] leading-[1.1] tracking-tight text-bone md:text-[34px]">
                Konkretes Vorhaben im Kopf?
              </h2>
              <p className="mt-3 max-w-[48ch] text-[14px] leading-relaxed text-bone/75">
                Der Anfrage-Assistent sammelt alles ein, was wir für eine belastbare Antwort brauchen.
              </p>
            </div>
            <a
              href="/projekt-anfragen"
