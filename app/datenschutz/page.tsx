...
export default function DatenschutzPage() {
  return (
    <LegalLayout label="Datenschutz" title="Datenschutz">
      ...
      <Section title="3. Anfrageformular">
        <p>
          Wenn Sie über unseren Anfrage-Assistenten ein Vorhaben schildern, erheben wir die von Ihnen angegebenen
          Daten: Projektart (Dach, Klempner, Pflaster, Terrasse, Garten), Postleitzahl und Ort, Flächenangaben,
          Planungsstand, Zeitrahmen, Budgetrahmen, hochgeladene Fotos sowie Ihre Kontaktdaten (Name, Telefonnummer,
          E-Mail-Adresse, bevorzugter Kanal und ggf. eine Nachricht). Diese Daten verwenden wir ausschließlich zur
          Bearbeitung und Beantwortung Ihrer Anfrage sowie zur Vorbereitung eines Angebots. Die Rechtsgrundlage ist
          Art. 6 Abs. 1 lit. b DSGVO (Vertragsanbahnung). Kommt kein Auftrag zustande, werden die Daten spätestens
          nach zwölf Monaten gelöscht, sofern keine gesetzlichen Aufbewahrungspflichten bestehen.
        </p>
      </Section>

      <Section title="4. Foto-Uploads">
        <p>
          Von Ihnen hochgeladene Fotos (z.B. vom Dach, der Dachrinne, der Zufahrt, dem Vorgarten oder von Skizzen)
          werden ausschließlich zur Einschätzung Ihres Vorhabens verwendet und nicht veröffentlicht. Bitte laden Sie
          keine Bilder hoch, auf denen dritte Personen erkennbar sind.
        </p>
      </Section>
